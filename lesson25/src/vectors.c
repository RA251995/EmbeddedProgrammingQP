...
/* Typedefs */
typedef void (*isr_p_t)(void);

/* Externs */
extern uint32_t __INITIAL_SP;
extern void __NO_RETURN __attribute__ ((naked)) Reset_Handler(void);

/* Function Prototypes */
void Unused_Handler(void);
/* Cortex-M fault exceptions */
extern void __NO_RETURN __attribute__ ((naked)) NMI_Handler(void);
extern void __NO_RETURN __attribute__ ((naked)) HardFault_Handler(void);
extern void __NO_RETURN __attribute__ ((naked)) MemManage_Handler(void);
extern void __NO_RETURN __attribute__ ((naked)) BusFault_Handler(void);
extern void __NO_RETURN __attribute__ ((naked)) UsageFault_Handler(void);
/* @formatter:off */
/* Cortex-M non-fault exceptions */
...
/* Constants */
isr_p_t const __VECTOR_TABLE_ATTRIBUTE __VECTOR_TABLE[128] = {
    (isr_p_t)&__INITIAL_SP,
    &Reset_Handler,
    &NMI_Handler,
    &HardFault_Handler,
    &MemManage_Handler,
